...
// - connect-src covers the two live APIs (NWS and Open-Meteo) and 'self',
//   for the parity summary the #parity page fetches from beside the site.
const CSP = [
  "default-src 'self'",
  "script-src 'self'",
  "style-src 'self' 'unsafe-inline'",
  "img-src 'self' data: https://radar.weather.gov",
  "connect-src 'self' https://api.weather.gov https://api.open-meteo.com",
  "base-uri 'self'",
  "form-action 'none'",
  "object-src 'none'",
].join('; ');
