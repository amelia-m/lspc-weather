 ...
 * says, and what a reader is asked to confirm. Rendered by CitationsPage and
 * formatted into a GitHub issue by domain/citationAnswers. Data, not
 * behaviour, which is why it lives beside thresholds.ts.
 *
